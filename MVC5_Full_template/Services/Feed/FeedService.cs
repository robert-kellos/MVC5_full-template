...
namespace MVC5_Full_template.Services.Feed
{
    using System;
    ...
    public sealed class FeedService : IFeedService
    {
        ...
        /// </remarks>
        public Task PublishUpdate() => _httpClient.PostAsync(
            PubSubHubbubHubUrl,
            ...
            await Task.Factory.StartNew(() =>
            {
                for (var i = 1; i < 4; ++i)
                {
                    ...
                    item.Links.Add(SyndicationLink.CreateMediaEnclosureLink(
                        new Uri(_urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png")),
                        ContentType.Png,
                        0));

                    // media:thumbnail - Add a Yahoo Media thumbnail for the entry. See http://www.rssboard.org/media-rss 
                    //                   for more information.
                    item.SetThumbnail(_urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png"), 48, 48);
