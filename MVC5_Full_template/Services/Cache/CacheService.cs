...
namespace MVC5_Full_template.Services.Cache
{
    using System;
    using System.Linq;
    ...
    public sealed class CacheService : ICacheService
    {
        ...
        /// <param name="afterItemRemoved">The action to perform after the cache entry has been removed.</param>
        /// <param name="beforeItemRemoved">The action to perform before the cache entry has been removed.</param>
        public void AddOrUpdate<T>(string key,
                                    T value,
        ...
        /// <exception cref="System.ArgumentNullException">key is null.</exception>
        public T Get<T>(string key) where T : class => (T)_memoryCache.Get(key);
        ...
        public T GetOrAdd<T>(string key,
                            ...
                            Action<string, T> afterItemRemoved = null,
                            Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAdd(key, value, null, null, afterItemRemoved, beforeItemRemoved);
        ...
        public T GetOrAdd<T>(string key,
                            ...
                            Action<string, T> afterItemRemoved = null,
                            Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAdd(key, value, absoluteExpiration, null, afterItemRemoved, beforeItemRemoved);
        ...
        public T GetOrAdd<T>(string key,
                            ...
                            Action<string, T> afterItemRemoved = null,
                            Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAdd(key, value, null, slidingExpiration, afterItemRemoved, beforeItemRemoved);
        ...
        public Task<T> GetOrAddAsync<T>(string key,
                                        ...
                                        Action<string, T> afterItemRemoved = null,
                                        Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAddAsync(key, value, null, null, afterItemRemoved, beforeItemRemoved);
        ...
        public Task<T> GetOrAddAsync<T>(string key,
                                        ...
                                        Action<string, T> afterItemRemoved = null,
                                        Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAddAsync(key, value, absoluteExpiration, null, afterItemRemoved, beforeItemRemoved);
        ...
        public Task<T> GetOrAddAsync<T>(string key,
                                        ...
                                        Action<string, T> afterItemRemoved = null,
                                        Action<string, T> beforeItemRemoved = null) where T : class
            => GetOrAddAsync(key, value, null, slidingExpiration, afterItemRemoved, beforeItemRemoved);
        ...
        /// <param name="beforeItemRemoved">The action to perform before the cache entry has been removed.</param>
        /// <returns>A reference to the cache entry that is identified by key.</returns>
        private T GetOrAdd<T>(string key,
                            Func<T> getValue,
                            DateTimeOffset? absoluteExpiration,
                            TimeSpan? slidingExpiration,
        ...
        /// <param name="beforeItemRemoved">The action to perform before the cache entry has been removed.</param>
        /// <returns>A reference to the cache entry that is identified by key.</returns>
        private async Task<T> GetOrAddAsync<T>(string key,
                                                ...
                                                Action<string, T> beforeItemRemoved) where T : class
        {
            ...
            value = await getValue().ConfigureAwait(true);
            AddOrUpdate(key,
                        value,
                        absoluteExpiration,
                        slidingExpiration,
        ...
        /// <param name="afterItemRemoved">The action to perform after the cache entry has been removed.</param>
        /// <param name="beforeItemRemoved">The action to perform before the cache entry has been removed.</param>
        private void AddOrUpdate<T>(string key,
                                    T value,
                                    DateTimeOffset? absoluteExpiration,
                                    TimeSpan? slidingExpiration,
                                    Action<string, T> afterItemRemoved,
