...
namespace MVC5_Full_template.Services
{
    using System.Text;
    ...
    public sealed class OpenSearchService : IOpenSearchService
    {
        ...
        public string GetOpenSearchXml()
        {
            ...
            // defined query.
            var searchUrl = this._urlHelper.AbsoluteRouteUrl(
            ...
            var searchFormUrl = this._urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetIndex);
            // The link to the favicon.ico file for the site.
            var favicon16Url = this._urlHelper.AbsoluteContent("~/content/icons/favicon.ico");
            // The link to the favicon.png file for the site.
            var favicon32Url = this._urlHelper.AbsoluteContent("~/content/icons/favicon-32x32.png");
            // The link to the favicon.png file for the site.
            var favicon96Url = this._urlHelper.AbsoluteContent("~/content/icons/favicon-96x96.png");
