...
namespace MVC5_Full_template.Controllers
{
    using System.Net;
    using System.Web.Mvc;
    using System.Web.UI;
    using MVC5_Full_template.Constants;
    using MVC5_Full_template.Constants.ErrorController;
    ...
    public sealed class ErrorController : Controller
    {
        ...
        [Route(ErrorControllerRoute.Template.BadRequest, Name = ErrorControllerRoute.GetBadRequest)]
        ...
        /// <summary>
        /// Returns a HTTP 500 Internal Server Error view. Returns a partial view if the request is an AJAX call.
        /// </summary>
